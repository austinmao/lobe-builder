...
Other add-ons may still influence _style, scope, and depth_, but **none of them may cancel, weaken, or deprioritize the TDD workflow**.
...
// your test app wrapper for Next route handlers
...
_(If user asks for a single patch only, you can combine A+B; still keep the test‑first ordering in the diff.)_
