...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_design_system" AS ENUM('untitledui', 'shadcn');
  ...
  CREATE TABLE "pages_blocks_cta" (
  	...
  	"primary_button_href" varchar NOT NULL,
  ...
  CREATE TABLE "pages" (
  	...
  	"slug" varchar NOT NULL,
  	"title" varchar NOT NULL,
  	"design_system" "enum_pages_design_system" DEFAULT 'untitledui' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_design_system";`);
}
